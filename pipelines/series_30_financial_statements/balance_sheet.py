# pipelines/series_30_financial_statements/balance_sheet.py
...
def main(asset_class: str = "equity", is_active: int = 1):
    ...
    backfill_all_symbols(client, table_fq=TABLE, statement="balance_sheet", period="annual", symbols=symbols, source=SOURCE)
    backfill_all_symbols(client, table_fq=TABLE, statement="balance_sheet", period="quarterly", symbols=symbols, source=SOURCE)

    print("[ok] balance_sheet: DDL + backfill completed")
